...
public class Course
	...
	@ApiModelProperty(name = "course name",
	                  value = "full name of the course",
	                  required = true,
	                  example = "AP Calculus")
	@Column(unique = true)
	@Size(min = 2,
	      max = 50,
	      message = "coursename must be at least 2 characters and at most 50 characters long")
	...
	@ApiModelProperty(name = "instructor",
	                  value = "instructor assigned to teach this course",
	                  required = true)
	@ManyToOne
